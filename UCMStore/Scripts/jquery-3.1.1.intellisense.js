intellisense.annotate(jQuery, {
  ...
  'ajaxSetup': function() {
    /// <signature>
    ///   <summary>Set default values for future Ajax requests. Its use is not rUCMStoremended.</summary>
  ...
  'extend': function() {
    ...
    /// <signature>
    ///   <summary>Merge the contents of two or more objects together into the first object.</summary>
    ///   <param name="deep" type="Boolean">If true, the merge bUCMStorees recursive (aka. deep copy).</param>
